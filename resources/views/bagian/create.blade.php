    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold mb-0">
                <i class="fas fa-plus-circle text-primary me-2"></i> Tambah Bagian
            </h3>
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="card-header text-white fw-semibold" style="background: linear-gradient(90deg, #007bff, #00c6ff);">
                <i class="fas fa-pen me-2"></i> Formulir Tambah Bagian
            </div>
                ...
                <form method="POST" action="{{ route('bagian.store') }}">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="nama_bagian" id="nama_bagian"
                            ...
                            value="{{ old('nama_bagian') }}" placeholder="Masukkan nama bagian..." required autofocus>
                        @error('nama_bagian')
