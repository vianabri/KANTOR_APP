    ...
    <div class="container py-4">
        <div class="d-flex justify-content-between align-items-center mb-4">
            <h3 class="fw-bold mb-0">
                <i class="fas fa-briefcase text-primary me-2"></i> Data Jabatan
            </h3>

            @can('manage jabatan')
                <a href="{{ route('jabatan.create') }}" class="btn btn-gradient-primary shadow">
        ...
        <div class="card border-0 shadow-lg rounded-4 overflow-hidden">
            <div class="card-header bg-gradient fw-semibold"
                ...
                <i class="fas fa-database me-2 text-primary"></i> Daftar Jabatan
            </div>
                ...
                <table class="table table-hover align-middle mb-0 table-custom">
                    <thead class="text-uppercase text-secondary small fw-bold">
                        <tr>
                            ...
                            <th class="text-center" width="25%">Bagian</th>
                        ...
                        @empty
                            <tr>
                                <td colspan="5" class="text-center text-muted py-5">
                                    ...
                                    <h6 class="fw-semibold">Belum ada data jabatan</h6>
